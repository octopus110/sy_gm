...
@section('content')
    <section class="Hui-article-box">
        ...
        <div class="Hui-article">
            <form action="/online/dau" method="post" class="form form-horizontal">
                {!! csrf_field() !!}
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="col-xs-1 col-sm-1">
                        <a href="/online/dau?status=2" target="_blank" class="btn btn-secondary radius">导出</a>
                    </div>

                    <div class="col-xs-2 col-sm-2">
                        <a href="javascript:;" onclick="show_graph('最高在线/平均在线','/online/dau?status=3')"
                           class="btn btn-secondary radius">图形化显示(活跃用户)</a>
                    </div>
                    <div class="col-xs-2 col-sm-2">
                        <a href="javascript:;" onclick="show_graph('最高在线/平均在线','/online/dau?status=4')"
                           class="btn btn-secondary radius">图形化显示(用户登陆次数)</a>
                    </div>
                    <div class="col-xs-2 col-sm-2">
                        <a href="javascript:;" onclick="show_graph('最高在线/平均在线','/online/dau?status=5')"
