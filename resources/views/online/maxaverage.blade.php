                ...
                <div class="row cl">
                    ...
                    <div class="col-xs-2 col-sm-2">
                        <a href="javascript:;" onclick="show_graph('最高在线/平均在线','/online/maxaverage?status=3')"
                           class="btn btn-secondary radius">图形化显示(最高在线)</a>
                    </div>

                    <div class="col-xs-2 col-sm-2">
                        <a href="javascript:;" onclick="show_graph('最高在线/平均在线','/online/maxaverage?status=4')"
                           class="btn btn-secondary radius">图形化显示(平均在线)</a>
                    </div>
                    <div class="col-xs-1 col-sm-1">
                        <a href="javascript:;" onclick="show_graph('最高在线/平均在线','/online/maxaverage?status=5')"
                           class="btn btn-secondary radius">图形化显示(高平比)</a>
                    </div>
                </div>
            </form>
