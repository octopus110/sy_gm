...
@section('content')
    <section class="Hui-article-box">
        <nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="/" class="maincolor">首页</a>
            ...
            <span class="c-999 en">&gt;</span>
            <span class="c-666">活跃用户</span>
            <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
               href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a>
        </nav>

        <div class="Hui-article">
            <form action="/user/active" method="post" class="form form-horizontal">
                {!! csrf_field() !!}
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="col-xs-1 col-sm-1">
                        <a href="/user/active?status=2" target="_blank" class="btn btn-secondary radius">导出</a>
                    </div>

                    <div class="col-xs-2 col-sm-2">
                        <a href="javascript:;" onclick="show_graph('最高在线/平均在线','/user/active?status=3')"
                           class="btn btn-secondary radius">图像化显示（活跃用户）</a>
                    </div>

                    <div class="col-xs-1 col-sm-1">
                        <a href="javascript:;" onclick="show_graph('最高在线/平均在线','/user/active?status=4')"
                           class="btn btn-secondary radius">图像化显示（增幅）</a>
                    </div>
                </div>
            </form>
