...
@section('content')
    <section class="Hui-article-box">
        ...
        <div class="Hui-article">
            <form action="/income/userPayment" method="post" class="form form-horizontal">
                {!! csrf_field() !!}
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="col-xs-1 col-sm-1">
                        <a href="/income/userPayment?status=2" target="_blank" class="btn btn-secondary radius">导出</a>
                    </div>
                </div>
            </form>
